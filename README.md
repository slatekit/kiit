...
[slatekit-functions](http://www.slatekit.com/infra.html)                    | [src](src/lib/kotlin/slatekit-functions)    | Apache2.0    | commands, syncs, scheduled tasks | [ ![Download](https://api.bintray.com/packages/codehelixinc/slatekit/slatekit-functions/images/download.svg) ](https://bintray.com/codehelixinc/slatekit/slatekit-functions/_latestVersion)
...
[slatekit-jobs](http://www.slatekit.com/kotlin-core-workers.html)    | [src](src/lib/kotlin/slatekit-jobs)  | LGPLv3   | background jobs for persistant job queues | [ ![Download](https://api.bintray.com/packages/codehelixinc/slatekit/slatekit-workers/images/download.svg) ](https://bintray.com/codehelixinc/slatekit/slatekit-jobs/_latestVersion)
