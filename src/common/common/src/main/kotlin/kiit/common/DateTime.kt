...
import kiit.common.ext.atStartOfMonth
import kiit.common.ext.daysInMonth
import kiit.common.checks.Check
import java.util.*

/**
 * Currently a typealias for the ThreeTenBP ZonedDateTime
 * The kiit.common uses this datetime library instead of Java 8 because:
 * 1. kiit.common is used for android projects
