 ...
 *
 * NOTES:
 * 1. A default implementation is available at @see[kiit.connectors.queuer.QQueue]
 * 2. Default implementation uses AWS SQS by leveraging Slate Kit Cloud project @see[kiit.providers.aws]
...
interface Queue {
    ...
    /**
     * Builds a Task with the supplied payload and adds it into the queue
     */
     ...
     */
    suspend fun send(task: Task): Try<String>
