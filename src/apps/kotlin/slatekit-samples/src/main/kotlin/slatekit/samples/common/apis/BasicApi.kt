...
@Api(area = "samples", name = "basic", desc = "sample to test features of Slate Kit APIs", auth = AuthModes.NONE, verb = Verbs.AUTO, sources = [Sources.WEB])
class BasicApi(context: Context) : ApiBase(context) {
    ...
    @Action(desc = "accepts basic data types")
