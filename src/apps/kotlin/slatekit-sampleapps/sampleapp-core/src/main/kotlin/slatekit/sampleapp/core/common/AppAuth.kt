  ...
  : Auth(keys, null)
{
  ...
  /**
    ...
    * @return
    */
  override fun isAuthorized(cmd:Request, mode:String, actionRoles:String, parentRoles:String)
  : Result<Boolean> {
      return super.isAuthorized(cmd, mode, actionRoles, parentRoles)
  }
  ...
  /**
    ...
    * @return
    */
  override fun isKeyRoleValid(cmd:Request, actionRoles:String, parentRoles:String):Result<Boolean> {

    return super.isKeyRoleValid(cmd, actionRoles, parentRoles)
  }
  ...
  /**
    ...
    * @return
    */
  override fun isAppRoleValid(cmd:Request, actionRoles:String, parentRoles:String): Result<Boolean> {

    return super.isAppRoleValid(cmd, actionRoles, parentRoles)
  }
  ...
  /**
    ...
    * @return
    */
  override protected fun getUserRoles(cmd: Request):String {
