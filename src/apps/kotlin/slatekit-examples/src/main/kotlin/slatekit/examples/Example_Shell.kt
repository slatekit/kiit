...
/*
class Example_Shell  : Cmd("auth") {

  //<doc:setup>
  class AppShell(meta: AppMeta, folders: Folders, settings: ShellSettings) : ShellService(folders, settings,meta)
  {
    ...
    override fun onShellStart(): Unit
    {
      ...
      apis.register<UserApi>(UserApi(ctx))
    ...
    override fun onCommandExecuteInternal(cmd:ShellCommand):ShellCommand
    {
      ...
      val apiCmd = Request.apply(cmd.line, cmd.args, opts, ApiConstants.ProtocolCLI)
  ...
  override fun executeInternal(args: Array<String>?) : Result<Any>
  {
    ...
    val shell = AppShell(AppMeta.none, Folders.default, ShellSettings())
