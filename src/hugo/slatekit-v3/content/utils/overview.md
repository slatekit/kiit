...
<table class="table">
  <tr>
    <td><a href="utils/args"><img src="assets/media/img/white/gears.png" width="70" alt=""></a></td>
    <td>Args</td>
    <td>A lexical command line arguments parser</td>
  </tr>
  <tr>
    <td><a href="utils/args"><img src="assets/media/img/white/gears.png" width="70" alt=""></a></td>
    <td>Args</td>
...
<section id="services" class="do">
  <div class="container">
      <div class="row text-center">
          <div class="col-md-4 wow fadeInUp">
            <div class="box text-center">
              <a href="utils/args"><img src="assets/media/img/white/gears.png" width="70" alt=""></a>         
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="box text-center">
              <a href="utils/config"><img src="assets/media/img/white/settings.png" width="70" alt=""></a>          
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="box text-center">
              <a href="utils/console"><img src="assets/media/img/white/console.png" width="70" alt=""></a>          
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="box text-center">
              <a href="utils/data"><img src="assets/media/img/white/layers.png" width="70" alt=""></a>          
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="box text-center">
              <a href="utils/datetime"><img src="assets/media/img/white/calendar.PNG" width="70" alt=""></a>            
