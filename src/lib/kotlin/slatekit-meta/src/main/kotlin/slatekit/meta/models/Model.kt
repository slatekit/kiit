...
class Model(val name: String,
    ...
    fun addText(name: String, desc: String = "", isRequired: Boolean = false, minLength: Int = 0,
        ...
        return addField(name, String::class, KTypes.KStringType, desc, isRequired, minLength, maxLength, storedName,
    ...
    fun addBool(name: String, desc: String = "", isRequired: Boolean = false,
        ...
        return addField(name, Boolean::class, KTypes.KBoolType, desc, isRequired, 0, 0, storedName, false, false, tag, cat)
    }
    ...
    fun addLocalDate(name: String, desc: String = "", isRequired: Boolean = false,
                     storedName: String? = null, tag: String = "", cat: String = "data"): Model {
        return addField(name, LocalDate::class, KTypes.KLocalDateType, desc, isRequired, 0, 0, storedName, DateTime.MIN, false, tag, cat)
    }
    ...
    fun addLocalTime(name: String, desc: String = "", isRequired: Boolean = false,
                     storedName: String? = null, tag: String = "", cat: String = "data"): Model {
        return addField(name, LocalTime::class, KTypes.KLocalTimeType, desc, isRequired, 0, 0, storedName, DateTime.MIN, false, tag, cat)
    }
    ...
    fun addLocalDateTime(name: String, desc: String = "", isRequired: Boolean = false,
                         storedName: String? = null, tag: String = "", cat: String = "data"): Model {
        return addField(name, LocalDateTime::class, KTypes.KLocalDateTimeType, desc, isRequired, 0, 0, storedName, DateTime.MIN, false, tag, cat)
    }
    ...
    fun addDateTime(name: String, desc: String = "", isRequired: Boolean = false,
                    storedName: String? = null, tag: String = "", cat: String = "data"): Model {
        return addField(name, DateTime::class, KTypes.KDateTimeType, desc, isRequired, 0, 0, storedName, DateTime.MIN, false, tag, cat)
    }
