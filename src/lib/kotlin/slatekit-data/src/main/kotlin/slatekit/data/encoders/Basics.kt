...
open class StringEncoder : SqlEncoder<String> {
    ...
    override fun convert(value: String?): Value = Value("", DataType.DTString, value, encode(value))
}
...
open class ShortEncoder(val dataType: DataType = DataType.DTShort) : SqlEncoder<Short> {
    ...
    override fun convert(value: Short?): Value {
        val finalValue = when(dataType){
...
open class IntEncoder : SqlEncoder<Int> {
    ...
    override fun convert(value: Int?): Value = Value("", DataType.DTInt, value, encode(value))
}
...
open class DoubleEncoder : SqlEncoder<Double> {
    ...
    override fun convert(value: Double?): Value = Value("", DataType.DTDouble, value, encode(value))
}
