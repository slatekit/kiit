...
//    }
    ...
    @Test fun can_parse_basictypes(){
        ...
        val deserializer = JsonDeserializer(CommonRequest.cli("a", "b", "c", "post", mapOf(), mapOf()))
    ...
    @Test fun can_parse_decrypted(){
        ...
        val deserializer = JsonDeserializer(CommonRequest.cli("a", "b", "c", "post", mapOf(), mapOf()), MyEncryptor)
    ...
    @Test fun can_parse_custom_types_using_lambda_decoder(){
        ...
        val deserializer = JsonDeserializer(req, null, mapOf(Pair(Movie::class.qualifiedName!!, decoder)))
    ...
    @Test fun can_parse_custom_types_using_simple_decoder(){
        ...
        val deserializer = JsonDeserializer(req, null, mapOf(Pair(Movie::class.qualifiedName!!, MovieDecoder())))
        val results = deserializer.deserialize(this::test_custom_converter.parameters, test)
        Assert.assertTrue(results[0] == "abc")
        Assert.assertTrue(results[1] == false)
        Assert.assertTrue(results[2] is Movie )
    ...
    @Test fun can_parse_custom_types_using_context(){
        ...
        val deserializer = JsonDeserializer(req, null, mapOf(Pair(Self::class.qualifiedName!!, JWTSelfDecoder())))
