...
class Db_Access_Postgres : TestSupport {
    ...
    private val localDate = org.threeten.bp.LocalDate.of(2021, 2, 1)
    private val localTime = org.threeten.bp.LocalTime.of(9, 30, 45)
    private val localDateTime = org.threeten.bp.LocalDateTime.of(2021, 2, 1, 9, 30, 45)
