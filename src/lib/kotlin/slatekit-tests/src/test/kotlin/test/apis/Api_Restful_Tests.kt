...
*/
    ...
    @Test fun can_get_by_id() {
        ...
        val apis = ApiContainer(ctx, apis = listOf(Api(SampleRESTApi::class, "app")), auth = null, allowIO = false, middleware = listOf(Restify()))
    ...
    fun can_create(){
        ...
        val apis = ApiContainer(ctx,
                apis = listOf(Api(SampleRESTApi::class, "app")),
    ...
    fun ensure(action:String, verb:String, args:Map<String,Any>, namer:Namer?, callback:(Result<*>) -> Unit): Unit {
        ...
        val api2 = ApiContainer(ctx, apis = listOf(Api(SampleRESTApi::class, "app")), auth = null, allowIO = false, middleware = listOf(Restify()), namer = namer)
