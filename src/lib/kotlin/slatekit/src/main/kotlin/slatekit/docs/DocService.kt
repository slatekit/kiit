...
class DocService(val _rootdir: String, val _outputDir: String, val templatePath: String) {
    ...
    private val _version = "0.9.17"

    private val _docs = listOf(
              Doc("Args"         ,  "slatekit-common"  , "slatekit.common.args"               ,"slatekit.common.args.Args"                    , _version, "Example_Args"             , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "A lexical command line argument parser with optional support for allowing a route/method call in the beginning")
            , Doc("Auth"         ,  "slatekit-common"  , "slatekit.common.auth"               ,"slatekit.common.auth.Auth"                    , _version, "Example_Auth"             , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "A simple authentication component to check current user role and permissions")
            , Doc("Config"       ,  "slatekit-common"  , "slatekit.common.conf"               ,"slatekit.common.conf.Config"                  , _version, "Example_Config"           , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Thin wrapper over typesafe config with decryption support, uri loading, and mapping of database connections and api keys")
            , Doc("Console"      ,  "slatekit-common"  , "slatekit.common.console"            ,"slatekit.common.console.Console"              , _version, "Example_Console"          , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Enhanced printing to console with support for semantic writing like title, subtitle, url, error, etc with colors")
            , Doc("Data"         ,  "slatekit-common"  , "slatekit.common.db"                 ,"slatekit.common.db.Db"                        , _version, "Example_Database"         , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Database access utilty to query and manage data using JDBC for MySql. Other database support coming later.")
            , Doc("DbLookup"     ,  "slatekit-common"  , "slatekit.common.db"                 ,"slatekit.common.db.DbLookup"                  , _version, "Example_DbLookup"         , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Database access utilty to query and manage data using JDBC for MySql. Other database support coming later.")
            , Doc("DateTime"     ,  "slatekit-common"  , "slatekit.common"                    ,"slatekit.common.DateTime"                     , _version, "Example_DateTime"         , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "DataTime wrapper around Java 8 LocalDateTime providing a simplified interface, some convenience, extra features.")
            , Doc("Encrypt"      ,  "slatekit-common"  , "slatekit.common.encrypt"            ,"slatekit.common.encrypt.Encryptor"            , _version, "Example_Encryptor"        , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Encryption using AES")
            , Doc("Env"          ,  "slatekit-common"  , "slatekit.common.envs"               ,"slatekit.common.envs.Env"                     , _version, "Example_Env"              , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Environment selector and validator for environments such as (local, dev, qa, stg, prod) )")
            , Doc("Folders"      ,  "slatekit-common"  , "slatekit.common.info"               ,"slatekit.common.info.Folders"                 , _version, "Example_Folders"          , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Standardized application folder setup; includes conf, cache, inputs, logs, outputs")
            , Doc("Info"         ,  "slatekit-common"  , "slatekit.common.info"               ,"slatekit.common.info.About"                   , _version, "Example_Info"             , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Get/Set useful diagnostics about the system, language runtime, application and more")
            , Doc("Lex"          ,  "slatekit-common"  , "slatekit.common.lex"                ,"slatekit.common.lex.Lexer"                    , _version, "Example_Lexer"            , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Lexer for parsing text into tokens")
            , Doc("Logger"       ,  "slatekit-common"  , "slatekit.common.log"                ,"slatekit.common.log.Logger"                   , _version, "Example_Logger"           , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "A simple logger with extensibility for using other 3rd party loggers")
            , Doc("Mapper"       ,  "slatekit-common"  , "slatekit.common.mapper"             ,"slatekit.common.mapper.Mapper"                , _version, "Example_Mapper"           , false , false, true , "utils", "slatekit.common.jar"  , "res"                    , "A simple auth component for desktop/local and web/concurrent apps" )
            , Doc("Queue"        ,  "slatekit-common"  , "slatekit.common.queues"             ,"slatekit.common.queues.QueueSource"           , _version, "Example_Queue"            , false , false, true , "infra", "slatekit.common.jar"  , "res"                    , "Queue implementation and interfaces used for Queue abstractions over Amazon SQS" )
            , Doc("Random"       ,  "slatekit-common"  , "slatekit.common"                    ,"slatekit.common.Random"                       , _version, "Example_Random"           , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "A random generator for strings, guids, numbers, alpha-numeric, and alpha-numeric-symbols for various lengths" )
            , Doc("Request"      ,  "slatekit-common"  , "slatekit.common.requests"           ,"slatekit.common.requests.Request"             , _version, "Example_Request"          , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "Models and abstracts a request that can represent either an HTTP request or a request from the CLI ( Command line )." )
            , Doc("Results"      ,  "slatekit-common"  , "slatekit.results"                   ,"slatekit.common.Result"                       , _version, "Example_Results"          , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "Models success / failures with status codes, message, and other fields. Compatible with http status codes." )
            , Doc("SmartValues"  ,  "slatekit-common"  , "slatekit.common.smartvalues"        ,"slatekit.common.smartvalues.Email"            , _version, "Example_SmartValues"      , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "A way to store, validate and describe strongly typed and formatted strings")
            , Doc("Todo"         ,  "slatekit-common"  , "slatekit.common"                    ,"slatekit.common.Todo"                         , _version, "Example_Todo"             , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "A programmatic approach to marking and tagging code that is strongly typed and consistent")
            , Doc("Serialization",  "slatekit-common"  , "slatekit.common.serialization"      ,"slatekit.common.serialization.Serializer"     , _version, "Example_Serialization"    , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "Serializers for data classes to generate CSV, Props, HOCON, JSON files")
            , Doc("Templates"    ,  "slatekit-common"  , "slatekit.common.templates"          ,"slatekit.common.templates.Templates"          , _version, "Example_Templates"        , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "A micro template system for processing text with variables, useful for generating dynamic emails/messages.")
            , Doc("Validations"  ,  "slatekit-common"  , "slatekit.common.validation"         ,"slatekit.common.validation.ValidationFuncs"   , _version, "Example_Validation"       , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "A set of validation related components, simple validation checks, RegEx checks, error collection and custom validators")
            , Doc("Utils"        ,  "slatekit-common"  , "slatekit.common.utils"              ,"slatekit.common.console.ConsoleWriter"        , _version, "Example_Utils"            , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "Various utilities available in the Slate library")
            ...
            , Doc("AWS-S3"       ,  "slatekit-cloud"   , "slatekit.cloud.aws.AwsCloudFiles"             ,"slatekit.cloud.aws.AwsCloudFiles"             , _version, "Example_Aws_S3"           , true  , false, false, "infra", "slatekit.cloud.jar"   , "res,com,core"        , "Abstraction layer on cloud file storage to Amazon S3"             )
            , Doc("AWS-SQS"      ,  "slatekit-cloud"   , "slatekit.cloud.aws.AwsCloudQueue"             ,"slatekit.cloud.aws.AwsCloudQueue"             , _version, "Example_Aws_Sqs"          , true  , true , false, "infra", "slatekit.cloud.jar"   , "res,com,core"        , "Abstraction layer on message queues using Amazon SQS"              )
            , Doc("Ctx"          ,  "slatekit-core"    , "slatekit.core.common.AppContext"              ,"slatekit.core.common.AppContext"              , _version, "Example_Context"          , true  , false, false, "infra", "slatekit.core.jar"    , "res,com"             , "An application context to contain common dependencies such as configs, logger, encryptor, etc, to be accessible to other components")
            , Doc("Cmd"          ,  "slatekit-core"    , "slatekit.core.cmds.Cmd"                       ,"slatekit.core.cmds.Cmd"                       , _version, "Example_Command"          , true  , false, false, "infra", "slatekit.core.jar"    , "res,com"             , "A variation to the command pattern to support ad-hoc execution of code, with support for metrics and time-stamps")
            , Doc("Email"        ,  "slatekit-core"    , "slatekit.core.sms.EmailService"               ,"slatekit.core.sms.EmailService"               , _version, "Example_Email"            , true  , false, false, "infra", "slatekit.core.jar"    , "res,com"             , "An Email service to send emails with support for templates using SendGrid as the default implementation")
            , Doc("Sms"          ,  "slatekit-core"    , "slatekit.core.sms.SmsService"                 ,"slatekit.core.sms.SmsService"                 , _version, "Example_Sms"              , true  , false, false, "infra", "slatekit.core.jar"    , "res,com"             , "An Sms ( Text message ) service to send text messages to mobile phones for confirmation codes and invites.")
            ...
            , Doc("Api"          ,  "slatekit-apis"    , "slatekit.apis.ApiHost"                   ,"slatekit.apis.ApiHost"                   , _version, "Example_Api"              , false , false, true , "infra", "slatekit.apis.jar"    , "com"                 , "An API Container to host protocol agnostic apis to run on the command line or web")
    ...
    fun processItems(names:List<String>): Try<String> {
        ...
        val docs = _docs.filter{ names.contains(it.name) }
