...
class DocService(val rootdir: String, val outputDir: String, val templatePathRaw: String) {
    ...
    private val docs = listOf(
            ...
            , Doc("Request"      ,  "slatekit-common"  , "slatekit.common.requests"           ,"slatekit.common.requests.Request"             , version, "Example_Request"          , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "Models and abstracts a request that can represent either an HTTP request or a request from the CLI ( Command line )." )
            ...
            , Doc("Cmd"          ,  "slatekit-core"    , "slatekit.core.cmds.Cmd"                       ,"slatekit.core.cmds.Cmd"                       , version, "Example_Command"          , true  , false, false, "infra", "slatekit.core.jar"    , "res,com"             , "A variation to the command pattern to support ad-hoc execution of code, with support for metrics and time-stamps")
            ...
            , Doc("Workers"      ,  "slatekit-core"    , "slatekit.core.workers.Worker"                 ,"slatekit.core.workers.Worker"                 , version, "Example_Workers"          , true  , false, false, "infra", "slatekit.core.jar"    , "com"                 , "Background workers that can be paused, resumed, stopped, with support for worker groups, metrics, and queue and more")
