...
class DocService(val rootdir: String, val outputDir: String, val templatePathRaw: String) {
    ...
    private val docs = listOf(
            ...
            , Doc("Api"          ,  "slatekit-apis"    , "slatekit.apis.ApiServer"                   ,"slatekit.apis.ApiServer"                   , version, "Example_Api"              , false , false, true , "infra", "slatekit.apis.jar"    , "com"                 , "An API Container to host protocol agnostic apis to run on the command line or web")
