...
class DocService(val rootdir: String, val outputDir: String, val templatePathRaw: String) {
    ...
    private val docs = listOf(
            ...
            , Doc("Config"       ,  "slatekit-common"  , "slatekit.common.conf"               ,"slatekit.common.conf.Config"                  , version, "Example_Config"           , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Thin wrapper on java properties based config with decryption support, uri loading, and mapping of database connections and api keys")
            ...
            , Doc("Connections"     ,  "slatekit-common"  , "slatekit.common.db"                 ,"slatekit.common.db.Connections"                  , version, "Example_DbLookup"         , true  , false, true , "utils", "slatekit.common.jar"  , "res"                    , "Database access utilty to query and manage data using JDBC for MySql. Other database support coming later.")
            ...
            , Doc("Queue"        ,  "slatekit-common"  , "slatekit.common.queues"             ,"slatekit.common.queues.Queue"           , version, "Example_Queue"            , false , false, true , "infra", "slatekit.common.jar"  , "res"                    , "Queue implementation and interfaces used for Queue abstractions over Amazon SQS" )
            ...
            , Doc("AWS-S3"       ,  "slatekit-cloud"   , "slatekit.cloud.aws.AwsCloudFiles"             ,"slatekit.cloud.aws.AwsCloudFiles"             , version, "Example_Cloud_Files"           , true  , false, false, "infra", "slatekit.cloud.jar"   , "res,com,core"        , "Abstraction layer on cloud file storage to Amazon S3"             )
            , Doc("AWS-SQS"      ,  "slatekit-cloud"   , "slatekit.cloud.aws.AwsCloudQueue"             ,"slatekit.cloud.aws.AwsCloudQueue"             , version, "Example_Cloud_Queues"          , true  , true , false, "infra", "slatekit.cloud.jar"   , "res,com,core"        , "Abstraction layer on message queues using Amazon SQS"              )
            ...
            , Doc("Orm-Repo"     ,  "slatekit-entities", "slatekit.common.entities.Repo"          ,"slatekit.common.entities.Repo"          , version, "Example_Entities_Repo"    , true  , false, false, "orm"  , "slatekit.entities.jar", "com"                 , "A repository pattern for entity/model CRUD operations")
            ...
            , Doc("Api"          ,  "slatekit-apis"    , "slatekit.apis.ApiServer"                   ,"slatekit.apis.ApiServer"                   , version, "Example_Api"              , false , false, true , "infra", "slatekit.apis.jar"    , "com"                 , "An API Container to host source agnostic apis to run on the command line or web")
