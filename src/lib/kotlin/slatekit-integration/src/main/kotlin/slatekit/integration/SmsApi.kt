...
@Api(area = "sys", name = "sms", desc = "api to send sms", roles = "ops", auth = "key-roles", verb = "*", protocol = "*")
class SmsApi(val svc: SmsService, context: AppContext) : ApiWithSupport(context) {
    /**
     * sends a message
    ...
    fun sendUsingTemplate(name: String, countryCode: String, phone: String, vars: Vars): Result<Boolean> {
