...
class DocService(val rootdir: String, val outputDir: String, val templatePathRaw: String) {
    ...
    private val docs = listOf(
            ...
            , Doc("Serialization",  "slatekit-common"  , "kiit.serialization"             ,"slatekit.common.serialization.Serializer"     , version, "Example_Serialization"    , true  , false, false, "utils", "slatekit.common.jar"  , "res"                    , "Serializers for data classes to generate CSV, Props, HOCON, JSON files")
            ...
            , Doc("Query"        ,  "slatekit-common"  , "kiit.query.Query"                         ,"kiit.query.Query"                         , version, "Example_Query"            , false , false, true , "utils", "slatekit.common.jar"  , ""                    , "Query pattern used for specifying search and selection criteria" )
            , Doc("Model"        ,  "kiit-meta"    , "slatekit.common.Model"                        ,"slatekit.common.Model"                        , version, "Example_Model"            , true  , false, false, "utils", "slatekit.common.jar"  , ""                    , "Allows construction of model schema with fields for code-generation. Also used in the ORM mapper" )
            , Doc("Reflect"      ,  "kiit-meta"    , "slatekit.common.Reflector"                    ,"slatekit.common.Reflector"                    , version, "Example_Reflect"          , true  , false, false, "utils", "slatekit.common.jar"  , ""                    , "Reflection helper to create instances, get methods, fields, annotations and more" )
