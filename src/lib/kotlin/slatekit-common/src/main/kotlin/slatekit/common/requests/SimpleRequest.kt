...
data class SimpleRequest(
    ...
    companion object {
        ...
        fun web(path: String, verb: String, tag: String = ""): Request {
            ...
            val req = SimpleRequest(path, parts, source = Source.Web, data = InputArgs(mapOf()), meta = InputArgs(mapOf()), verb = verb, tag = tag)
            return req
        }
        ...
        fun cli(area: String, api: String, action: String, verb: String, opts: Map<String, Any>, args: Map<String, Any>, raw: Any? = null): Request {
            ...
            return SimpleRequest(path, listOf(area, api, action), Source.CLI, verb, InputArgs(args), meta = InputArgs(opts), raw = raw)
        }
        ...
        fun cli(path: String, verb: String, meta: Metadata?, args: Args, raw: Any?): Request {
            return SimpleRequest(path, args.actionParts, Source.CLI, verb, args, meta
                    ?: InputArgs(mapOf()), raw, "")
        }
        ...
        fun cli(
            ...
            val req = SimpleRequest(path, tokens, Source.CLI, "get", args, opts,
