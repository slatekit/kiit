...
object ResultFuncs {
    ...
    fun help(msg: String? = "success",
             tag: String? = "",
             ref: Any? = null): Result<String> {
        return Failure(HELP, err = null, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun exit(msg: String? = "exit",
             tag: String? = null,
             ref: Any? = null): Result<String> {
        return Failure(EXIT, err = null, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun ok(msg: String? = null,
           tag: String? = null,
           ref: Any? = null): Result<Boolean> {
        return Success(SUCCESS, true, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun yesWithCode(code: Int,
                    ...
                    tag: String? = null,
                    ref: Any? = null): Result<Boolean> {
        return Success(code, true, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun no(msg: String? = null,
           tag: String? = null,
           ref: Any? = null): Result<Boolean> {
        return Failure(FAILURE, err = null, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun okOrFailure(success: Boolean,
                    ...
                    ref: Any? = null): Result<Boolean> {
        return if (success)
            Success(SUCCESS, true, msg, tag, ref)
        else
            Failure(FAILURE, msg = msg, err = null, tag = tag, ref = ref)
    }
    ...
    //    else
    //      Result<T>(code, msg = msg, err = null, tag = tag, ref = ref)
    //  }
    //
    //
    ...
    fun <T> successOrError(success: Boolean,
        ...
        return if (success && value != null)
            Success(SUCCESS, value, msg = msg, tag = tag, ref = ref)
        else
            Failure(FAILURE, err = null, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> successOrError(callback: () -> T): Result<T> {
        return try {
            val v = callback()
            Success(SUCCESS, v, null, null, null)
        }
        catch(ex: Exception) {
            Failure(FAILURE, ex, ex.message, null, null)
        }
    }
    ...
    fun <T> success(data: T,
                    ...
                    tag: String? = null,
                    ref: Any? = null): Result<T> {
        return Success(SUCCESS, data, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> successWithCode(code: Int,
                            ...
                            tag: String? = null,
                            ref: Any? = null): Result<T> {
        return Success(code, data, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> confirm(data: T,
                    ...
                    tag: String? = null,
                    ref: Any? = null): Result<T> {
        return Success(CONFIRM, data, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> failure(msg: String? = "failure",
                    ...
                    tag: String? = null,
                    ref: Any? = null): Result<T> {
        return Failure(FAILURE, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> failureWithCode(code: Int,
        ...
        return Failure(code, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> unAuthorized(msg: String? = "unauthorized",
                         ...
                         tag: String? = null,
                         ref: Any? = null): Result<T> {
        return Failure(UNAUTHORIZED, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> notFound(msg: String? = "not found",
                     ...
                     tag: String? = null,
                     ref: Any? = null): Result<T> {
        return Failure(NOT_FOUND, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> badRequest(msg: String? = "not found",
                       ...
                       tag: String? = null,
                       ref: Any? = null): Result<T> {
        return Failure(BAD_REQUEST, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> conflict(msg: String? = "conflict",
                     ...
                     tag: String? = null,
                     ref: Any? = null): Result<T> {
        return Failure(CONFLICT, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> deprecated(msg: String? = "deprecated",
                       ...
                       tag: String? = null,
                       ref: Any? = null): Result<T> {
        return Failure(DEPRECATED, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> unexpectedError(msg: String? = "unexpected error",
                            ...
                            tag: String? = null,
                            ref: Any? = null): Result<T> {
        return Failure(UNEXPECTED_ERROR, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> notAvailable(msg: String? = "not available",
                         ...
                         tag: String? = null,
                         ref: Any? = null): Result<T> {
        return Failure(NOT_AVAILABLE, err, msg = msg, tag = tag, ref = ref)
    }
    ...
    fun <T> notImplemented(msg: String? = "not implemented",
                           ...
                           tag: String? = null,
                           ref: Any? = null): Result<T> {
        return Failure(NOT_IMPLEMENTED, err, msg = msg, tag = tag, ref = ref)
    }
}
