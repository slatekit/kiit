 ...
 * sys.codegen.toJava -templatesFolder="user://dev/tmp/slatekit/scripts/templates/codegen/swift" -outputFolder="user://dev/tmp/codegen/java" -packageName="blendlife" -classFile="" -methodFile="" -modelFile=""
 */
