...
import kiit.core.docs.CloudDocs
...
) : CloudDocs<TEntity, TPartition, TCluster> {

    private val client =
        AmazonDynamoDBClientBuilder.standard().withCredentials(AWSStaticCredentialsProvider(creds)).build()
